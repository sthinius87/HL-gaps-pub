...
try:
    xgb_model = load("../../data/processed/reg_XGB.joblib")
except FileNotFoundError:
    print("Error: '../../data/processed/reg_XGB.joblib' not found.")
    exit()
...
pickle_output_filename = "../../data/processed/xgb_evaluation_metrics_summary.pkl"
csv_output_filename = "../../data/processed/xgb_evaluation_metrics_summary.csv"
