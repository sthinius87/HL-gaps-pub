...
try:
    xgb_model = load("../../data/processed/reg_RF.joblib")
except FileNotFoundError:
    print("Error: '../../data/processed/reg_RF.joblib' not found.")
    exit()
...
pickle_output_filename = "../../data/processed/rf_evaluation_metrics_summary.pkl"
csv_output_filename = "../../data/processed/rf_evaluation_metrics_summary.csv"
