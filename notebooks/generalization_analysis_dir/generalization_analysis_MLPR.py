...
for i, (train_index, test_index) in enumerate(ss.split(X_scaled)):
    ...
    y_pred_train = mlpr_model.predict(X_train)
    y_pred_test = mlpr_model.predict(X_test)
...
pickle_output_filename = "../../data/processed/mlpr_evaluation_metrics_summary.pkl"
csv_output_filename = "../../data/processed/mlp_evaluation_metrics_summary.csv"
